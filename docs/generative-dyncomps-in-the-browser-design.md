...
- **`moonc` already emits canonical-ABI names.** Raw `gen.wasm` imports
  `tutuca:component/control@0.6.0` `emit` and
  `[export]tutuca:component/guest@0.6.0` `[resource-new]instance`; it exports
  `tutuca:component/guest@0.6.0#[method]instance.get-field`, `cabi_post_*`,
