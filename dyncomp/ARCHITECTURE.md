...
|---|---|---|
| `dyncomp/wit` | v0.12.0 | the fixed runtime behavior contract; static fields, protocols, and visibility-tagged properties live in manifest v3 |
...
`tutuca/spec` block and templates, through `gen`):
